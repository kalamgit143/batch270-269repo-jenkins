...
{
	public static void createXLSFile(String filepath) throws Exception
	{
	...
	public static void createXLSXFile(String filepath) throws Exception
	{
	...
	public static Workbook openExcelFile(String filepath) throws Exception
	{
		//either ".xls" or ".xlsx"
		File f=new File(filepath);
	...
	public static Sheet openSheet(Workbook wb, Object input) 
	{
		Sheet sht;
	...
	public static Sheet addSheet(Workbook wb, String sheetName)
	{
		Sheet sht=wb.createSheet(sheetName);
		return(sht);
	}
	
	public static int getRowsCount(Sheet sht)
	{
		int nour=sht.getPhysicalNumberOfRows();
		return(nour);
	}
	
	public static int getCellscount(Sheet sht, int rowindex)
	{
		int nouc=sht.getRow(rowindex).getLastCellNum(); 
		return(nouc);
	}
	
	public static void createResultColumn(Sheet sht, int cellindex)
	{
	...
	public static String getCellValue(Sheet sht, int rowindex, int cellindex)
	{
	...
	public static void setCellValue(Sheet sht, int rowindex, int cellindex, String value) throws Exception
	{
		try
		{
			//If row is used row
	...
	public static void setCellValue(Sheet sht, int rowindex, int cellindex, String value, 
			int fontSize, String fontName, boolean bold, boolean italic, short fontColor, 
			short bgColor, String align)
	{
		Font font=sht.getWorkbook().createFont();
		...
		style.setAlignment(HorizontalAlignment.valueOf(align.toUpperCase()));
		try
		{
			//If row is used row
			sht.getRow(rowindex).createCell(cellindex).setCellValue(value);
	...
	public static void saveAndCloseExcel(Workbook wb, String filepath) throws Exception
	{
